...
Un point de vigilance de gouvernance fréquent : le RSSI, pour rester indépendant, ne devrait idéalement pas être rattaché hiérarchiquement à la DSI qu'il est censé challenger.
...
- **ISO/IEC 27001** : SMSI, avec un accent fort sur le pilotage par la direction (clause 5).
- **COBIT** : cadre de gouvernance des systèmes d'information au sens large, incluant la sécurité.
- **NIST Cybersecurity Framework** : structure la gouvernance autour de cinq fonctions (Identify, Protect, Detect, Respond, Recover), largement adoptée au-delà du contexte américain.
