...
!!! tip "Présentation de ce chapitre"
    [🖥 Ouvrir les diapositives](../../presentation.html?deck=10-service-web/slides/01-introduction-services-web-http.txt){ target=_blank }
...
| En-tête | Rôle |
|---|---|
| `Content-Type` | Indique le format du corps envoyé (ex. `application/json`, `application/xml`) |
...
| `Location` | Indique, en réponse à une création (`201 Created`), l'URI de la ressource créée |
